...
#device _ID = "3PI_16167641"
#client.publish("matzi/0/"+device _ID, ' {"type":"set_state", "action":"set_value", "addr":0, "cname":"ONOFF", "value":1}')
# and consequently 'OFF':
#client.publish("matzi/0/"+device _ID, ' {"type":"set_state", "action":"set_value", "addr":0, "cname":"ONOFF", "value":0}')

# Next loop will publishing all messages during running time
client.loop_start()
client.publish("matzi/all",'{"type":"identify"}')
